...
class ConnectedVehicle : public IVehicle, public IGPSVehicle {
  ...
  public:
    ...
    void checkFuel() const { cout << fuelLevel << endl; }
...
class AutonomousCar : public ConnectedVehicle {
  ...
  public:
    AutonomousCar() : ConnectedVehicle() { carID = "0000"; }

    AutonomousCar(string vehicleName, string cardID)
        : ConnectedVehicle(vehicleName, 0) {
        this->carID = cardID;
    }
